...
class StudentMonthlyTrack extends StatefulWidget {
  ...
  const StudentMonthlyTrack({
    super.key,
    required this.studentTracks,
  });
                    ...
                    DateContainer(
                      ...
                      onTap: (p0) async {
                        if (p0 != null) {
                          ...
                          if (item.isNotEmpty) {
                            studentTrackModel =
                                StudentMonthlyTrackModel.fromJson(item.first);
                            maxDayOfTheDate = DateTime(
                                    int.parse(studentTrackModel!.date
                                        .split('-')
                                        .first),
                                    int.parse(studentTrackModel!.date
                                            .split('-')
                            ...
                            child: SingleChildScrollView(
                              child: Column(
                                children: [
                                  ...
                                  MonthlyProgressContainer(
                                      width: 291.w,
                                      data: studentTrackModel!.hadithProgress,
                                      title: 'حفظ الحديث'),
                                  SizedBox(height: 15.h),
                                  Container(
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                          studentTrackModel!.behave.toString(),
                                          textAlign: TextAlign.end,
                                          overflow: TextOverflow.ellipsis,
                                          style: TextStyle(
                                              color: AppColors.darkBrownColor,
